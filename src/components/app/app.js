...
class App extends Component {
    constructor(props) {
        ...
        this.state = {
            data: [
                {name: 'Sergey Z.', salary: 3000, increase: false, rise:false, id: 1},
                {name: 'Irina I.', salary: 900, increase: true, rise:true, id: 2},
                {name: 'Alexei O.', salary: 6000, increase: false, rise:false, id: 3},
                {name: 'Julia K.', salary: 2500, increase: false, rise:false, id: 4},
            ],
            term: '', 
            filter: 'all',
        }
